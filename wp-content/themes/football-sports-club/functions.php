...
function football_sports_club_getpage_css($hook) {
	wp_enqueue_script( 'football-sports-club-admin-script', get_template_directory_uri() . '/inc/admin/js/football-sports-club-admin-notice-script.js', array( 'jquery' ) );
    wp_localize_script( 'football-sports-club-admin-script', 'football_sports_club_ajax_object',
    ...
    if ( !$dismissed) { ?>
        <div class="updated notice notice-success is-dismissible notice-get-started-class" data-notice="get_started" style="background: #f7f9f9; padding: 20px 10px; display: flex;">
	    	...
	    	<div class="tm-admin-content" style="padding-left: 30px; align-self: center">
	        	...
	        	<a class="admin-notice-btn button button-primary button-hero" target="_blank" href="<?php echo esc_url( FOOTBALL_SPORTS_CLUB_PRO_DOC ); ?>"><?php esc_html_e( 'Documentation', 'football-sports-club' ) ?></a>
